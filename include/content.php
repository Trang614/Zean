<div class="content">
	...
	<div class="content-top">
		...
		<div class="grid-in">
			...
			<p><a href="single.php">Áo Thun</a></p>
			</div>
			<div class="col-md-4 grid-top">
		...
		<div class="grid-in">
			...
			<p><a href="single.php">Áo Sơ-mi</a></p>
			</div>
			<div class="col-md-4 grid-top">
			...
			<p><a href="single.php">Cặp da</a></p>
			</div>
			<div class="col-md-4 grid-top">
			...
			<p><a href="single.php">Giày thể thao</a></p>
			</div>
					<div class="clearfix"> </div>
		</div>
	</div>
